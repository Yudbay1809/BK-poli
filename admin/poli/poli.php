        ...
        <?php
          ...
          if (mysqli_num_rows($result) > 0) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
              ...
              echo "<td>";
              echo "<a href='edit_poli.php?id=".$row['id']."' class='btn btn-warning btn-sm'>Edit</a>";
              echo "<a href='hapus_poli.php?id=".$row['id']."' class='btn btn-danger btn-sm' onclick='return confirm(\"Apakah Anda yakin ingin menghapus poli ini?\")'>Hapus</a>";
              echo "</td>";
              echo "</tr>";
              $no++;
            }
          } else {
            echo "<tr><td colspan='5'>Belum ada data poli.</td></tr>";
          }
        ?>
      </tbody>
    </table>
